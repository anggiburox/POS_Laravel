...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3 needs-validation" action="/leader/pembayaran/store" method="POST">
                {{ csrf_field() }}
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">ID Pembayaran <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="id_pembayaran" value="{{$kode}}" required readonly
                ...
                <div class="col-12">
                    <button class="btn btn-success" type="submit"><i class='bi bi-check-circle'></i>&nbsp;
                        Tambah</button>
                    <a href="/leader/pembayaran" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                        Kembali</a>
                </div>
