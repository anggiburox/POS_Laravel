...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach($pgw as $pp)
            <form class="row g-3 needs-validation" id="form-perbaharui" action="/leader/profile/editprofile"
                method="POST">
                {{ csrf_field() }}

                <div class="row mb-3">
                    <input type="hidden" class="form-control" name="id_leader" value="{{$pp->ID_Leader}}" required
                ...
                <div class="col-12">
                    <button class="btn btn-success" type="button" onclick="showConfirmation()"><i
                        ...
                        Perbaharui</button>
                    <a href="/leader/dashboard" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                        Kembali</a>
                </div>
