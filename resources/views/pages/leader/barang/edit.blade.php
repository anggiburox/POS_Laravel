...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach($pgw as $pp)
            <form class="row g-3 needs-validation" id="form-perbaharui" action="/leader/barang/update" method="POST">
                {{ csrf_field() }}
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">ID Barang <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="id_barang" value="{{$pp->ID_Barang}}" required
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Nama barang <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nama_barang" value='{{$pp->Nama_Barang}}'
                            required>
                    </div>
                </div>
                <div class="col-12">
                    <button class="btn btn-success" type="button" onclick="showConfirmation()"><i
                        ...
                        Perbaharui</button>
                    <a href="/leader/barang" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                        Kembali</a>
                </div>
