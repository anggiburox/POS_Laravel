...
@section('content')
<div class="pagetitle">
    <h1>Perbaharui Data Rekap Jenis Layanan</h1>
</div><!-- End Page Title -->
...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach($pgw as $pp)
            <form class="row g-3 needs-validation" id="form-perbaharui" action="/leader/rekap_jenis_layanan/update"
                method="POST">
                {{ csrf_field() }}
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">ID Rekap Jenis Layanan <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="id_jenis_layanan"
                            value="{{$pp->ID_Jenis_Layanan}}" required readonly style="background-color:#e6e6fa;">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Nama Layanan <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nama_layanan" value='{{$pp->Nama_Layanan}}'
                            required>
                    </div>
                </div>
                <div class="col-12">
                    <button class="btn btn-success" type="button" onclick="showConfirmation()"><i
                        ...
                        Perbaharui</button>
                    <a href="/leader/rekap_jenis_layanan" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                        Kembali</a>
                </div>
