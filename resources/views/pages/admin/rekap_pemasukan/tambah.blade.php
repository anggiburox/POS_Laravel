...
@section('content')
<div class="pagetitle">
    <h1>Tambah Data Rekap Pemasukan</h1>
</div><!-- End Page Title -->
...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3 needs-validation" action="/admin/rekap_pemasukan/store" method="POST"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="id_pemasukan" id="id_pemasukan" value="{{$kode}}"
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Tanggal <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" name="tanggal_pemasukan" value="<?= date('Y-m-d') ?>"
                            required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="col-12">
                    <button class="btn btn-success" type="submit"><i class='bi bi-check-circle'></i>&nbsp;
                        Tambah</button>
                    <a href="/admin/rekap_pemasukan" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                        Kembali</a>
                </div>
