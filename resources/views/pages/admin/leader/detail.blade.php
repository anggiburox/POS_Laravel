            ...
            <form class="row g-3 needs-validation" id="form-perbaharui" action="/admin/leader/update" method="POST">
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Nama Leader <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nama_leader" value='{{$pp->Nama_Leader}}' required
                            readonly style="background-color:#e6e6fa;">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="date" class="form-control" name="tanggal_lahir"
                            value='{{$pp->Tanggal_Lahir_Leader}}' required readonly style="background-color:#e6e6fa;">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Alamat Leader <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <textarea name='alamat_leader' class='form-control' required readonly
                            style="background-color:#e6e6fa;">{{$pp->Alamat_Leader}}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="number" min='0' class="form-control" name="telepon_leader"
                            value='{{$pp->Nomor_Telepon_Leader}}' required readonly style="background-color:#e6e6fa;">
                    </div>
                </div>
