 <table class="table table-sm">
     ...
     <tr>
         <td>
             <input type="text" name="pengeluaran[1]" class="form-control" value="" style="background-color:#e6e6fa;">
         </td>
         <td>
     ...
     <tr>
         <td>
             <input type="text" name="pengeluaran[4]" class="form-control" value="" style="background-color:#e6e6fa;">
         </td>
         <td>
     ...
     <tr>
         <td>
             <input type="text" name="pengeluaran[7]" class="form-control" value="" style="background-color:#e6e6fa;">
         </td>
         <td>
     ...
     <tr>
         <td>
             <input type="text" name="pengeluaran[10]" class="form-control" value="" style="background-color:#e6e6fa;">
         </td>
         <td>
     ...
     <tr>
         <td>
             <input type="text" name="pengeluaran[13]" class="form-control" value="" style="background-color:#e6e6fa;">
         </td>
         <td>
