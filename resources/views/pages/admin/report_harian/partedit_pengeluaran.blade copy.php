 <table class="table table-sm">
     ...
     <tr>
         ...
         <td>
             <input type="number" min="0" class="form-control"  name="pengeluaran[3]" value="{{ $ListPengeluaran->{3} }}"
                 style="background-color:#e6e6fa;">
     ...
     <tr>
         ...
         <td>
             <input type="number" min="0" class="form-control"  name="pengeluaran[6]" value="{{ $ListPengeluaran->{6} }}"
                 style="background-color:#e6e6fa;">
     ...
     <tr>
         ...
         <td>
             <input type="number" min="0" class="form-control"  name="pengeluaran[9]" value="{{ $ListPengeluaran->{9} }}"
                 style="background-color:#e6e6fa;">
     ...
     <tr>
         ...
         <td>
             <input type="number" min="0" class="form-control"  name="pengeluaran[12]" value="{{ $ListPengeluaran->{12} }}"
                 style="background-color:#e6e6fa;">
     ...
     <tr>
         ...
         <td>
             <input type="number" min="0" class="form-control"  name="pengeluaran[15]" value="{{ $ListPengeluaran->{15} }}"
                 style="background-color:#e6e6fa;">
