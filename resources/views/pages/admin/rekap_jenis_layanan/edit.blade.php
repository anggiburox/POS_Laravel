...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach($pgw as $pp)
            <form class="row g-3 needs-validation" id="form-perbaharui" action="/admin/rekap_jenis_layanan/update"
                method="POST">
                {{ csrf_field() }}
                <div class="row mb-3">
                ...
                <div class="col-12">
                    <button class="btn btn-success" type="button" onclick="showConfirmation()"><i
                        ...
                        Perbaharui</button>
                    <a href="/admin/rekap_jenis_layanan" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                        Kembali</a>
                </div>
