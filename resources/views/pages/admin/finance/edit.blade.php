...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach($pgw as $pp)
            <form class="row g-3 needs-validation" id="form-perbaharui" action="/admin/leader/update"
                method="POST">
                {{ csrf_field() }}
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="id_leader" value="{{$pp->ID_Leader}}"
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Tempat Lahir <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="tempat_lahir" value='{{$pp->Tempat_Lahir_Leader}}' required>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Tanggal Lahir <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="date" class="form-control" name="tanggal_lahir" value='{{$pp->Tanggal_Lahir_Leader}}' required>
                    </div>
                </div>
                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                value="Perempuan" {{$pp->Jenis_Kelamin_Leader == 'Perempuan' ? 'checked' : ''}}
                                                required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                value="Laki-Laki" {{$pp->Jenis_Kelamin_Leader == 'Laki-Laki' ? 'checked' : ''}}
                                                required>
                                            <label class="form-check-label">
                                                Laki-Laki
                                            </label>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Nomor Telepon <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="number" min='0' class="form-control" name="telepon_leader" value='{{$pp->Nomor_Telepon_Leader}}'required>
                    </div>
                </div>
                <div class="col-12">
