...
<div class="col-xl-12 col-xxl-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3 needs-validation" action="/admin/finance/store" method="POST">
                {{ csrf_field() }}
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">ID Finance <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="id_finance" value="{{$kode}}" required readonly
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Nama Finance <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nama_finance" required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Alamat Finance <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <textarea name='alamat_finance' class='form-control' required></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-4 col-form-label">Nomor Telepon <label
                            style='color:red;'>(*)</label></label>
                    <div class="col-sm-5">
                        <input type="number" min='0' class="form-control" name="telepon_finance" required>
                    </div>
                </div>
                <div class="row mb-3">
