...
class PembayaranControllerAdmin extends Controller
{
    /**
    ...
    {   
        ...
        return view('pages/admin/pembayaran/index',['pgw' => $pgw]);
    }

	
    public function tambah(){
		$kode = PembayaranModel::kode();
        return view('pages/admin/pembayaran/tambah', ['kode'=>$kode]);
    }
	...
	return redirect('/admin/pembayaran/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/admin/pembayaran/edit',['pgw' => $pgw]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman pembayaran
		return redirect('/admin/pembayaran')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function hapus($id){
		...
		return redirect('/admin/pembayaran')->withDanger('Data pembayaran tidak ditemukan');
	}
