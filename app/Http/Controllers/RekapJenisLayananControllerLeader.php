...
class RekapJenisLayananControllerLeader extends Controller
{
    /**
    ...
    {   
        ...
        return view('pages/leader/rekap_jenis_layanan/index',['pgw' => $pgw]);
    }

	
    public function tambah(){
		$kode = RekapJenisLayananModel::kode();
        return view('pages/leader/rekap_jenis_layanan/tambah', ['kode'=>$kode]);
    }
	...
	return redirect('/leader/rekap_jenis_layanan/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/leader/rekap_jenis_layanan/edit',['pgw' => $pgw]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman jenis_layanan
		return redirect('/leader/rekap_jenis_layanan')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function hapus($id){
		...
		return redirect('/leader/rekap_jenis_layanan')->withDanger('Data jenis_layanan tidak ditemukan');
	}
