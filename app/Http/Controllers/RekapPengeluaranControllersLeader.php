...
class RekapPengeluaranControllersLeader extends Controller
{
    /**
    ...
    {   
        $pgw = RekapPengeluaranModel::IndexJoinSession(session()->get('id_leader'));
        return view('pages/leader/rekap_pengeluaran/index',['pgw' => $pgw]);
    }

	
    public function tambah(){
		$kode = RekapPengeluaranModel::kode();
		$pemasukan = RekaPemasukanModel::JoinOutletLeaderPemasukanSession(session()->get('id_leader'));
        return view('pages/leader/rekap_pengeluaran/tambah', ['kode'=>$kode,'pemasukan'=>$pemasukan]);
    }
	...
	return redirect('/leader/rekap_pengeluaran/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/leader/rekap_pengeluaran/edit',['pgw' => $pgw, 'pemasukan'=>$pemasukan, 'ListPengeluaran'=>$ListPengeluaran]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman rekap_pengeluaran
		return redirect('/leader/rekap_pengeluaran')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function cetak($ID_Rekap_Pengeluaran)
{
	...
	return view('pages/leader/rekap_pengeluaran/laporan', ['pgw' => $pgw,'ListPengeluaran'=>$ListPengeluaran]);
	...
	public function hapus($id){
		...
		return redirect('/leader/rekap_pengeluaran')->withDanger('Data rekap_pengeluaran tidak ditemukan');
	}
