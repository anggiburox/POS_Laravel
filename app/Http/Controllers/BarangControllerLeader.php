...
class BarangControllerLeader extends Controller
{
    /**
    ...
    {   
        $pgw = BarangModel::get();
        return view('pages/leader/barang/index',['pgw' => $pgw]);
    }

	
    public function tambah(){
		$kode = BarangModel::kode();
        return view('pages/leader/barang/tambah', ['kode'=>$kode]);
    }
	...
	return redirect('/leader/barang/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/leader/barang/edit',['pgw' => $pgw]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman barang
		return redirect('/leader/barang')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function hapus($id){
		...
		return redirect('/leader/barang')->withDanger('Data barang tidak ditemukan');
	}
