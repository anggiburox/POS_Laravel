...
class RekapPemasukanControllerAdmin extends Controller
{
    /**
    ...
    {   
        $pgw = RekaPemasukanModel::IndexJoin();
        return view('pages/admin/rekap_pemasukan/index',['pgw' => $pgw]);
    }
    ...
    public function tambah(){
        ...
        return view('pages/admin/rekap_pemasukan/tambah', ['kode'=>$kode,'outlet'=>$outlet,'barang'=>$barang, 'jenis_layanan'=>$jenis_layanan, 'jenis_pembayaran'=>$jenis_pembayaran]);
    }
	...
	return redirect('/admin/rekap_pemasukan/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/admin/rekap_pemasukan/edit',['pgw' => $pgw, 'outlet'=>$outlet,'barang'=>$barang, 'jenis_layanan'=>$jenis_layanan, 'jenis_pembayaran'=>$jenis_pembayaran]);
	}
	...
	foreach ($id_barang as $key  => $value) {
		...
		// alihkan halaman ke halaman rekap_pemasukan
		return redirect('/admin/rekap_pemasukan')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function cetak($ID_Pemasukan)
{
	...
	return view('pages/admin/rekap_pemasukan/laporan', ['pgw' => $pgw]);
	...
	public function hapus($id){
		...
		return redirect('/admin/rekap_pemasukan')->withDanger('Data rekap_pemasukan tidak ditemukan');
	}
